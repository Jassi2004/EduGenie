...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <h1 className="font-bold text-4xl p-10 mt-80 flex justify-center">SCROLL TO STUDY NOW</h1>
      <h1 className="font-bold text-4xl flex justify-center">Study Material By Your Peers</h1>
        <PublishedNotesPage/>
      </div>
...
//           className="moving-gradient h-full flex flex-col justify-between p-4 bg-gradient-to-r from-white via-gray-100 to-gray-200 hover:shadow-lg transition-all duration-300"
//         >
//           <CardHeader className="flex items-center justify-center space-x-2 p-center">
//             <h1 className="font-bold p-4xl">Generate Test</h1>
//           </CardHeader>
//           <p className="p-gray-600 p-center mt-2 mb-4">
//             Quickly create organized test for your practice or exams.
//           </p>
//           <CardBody className="flex justify-center">
//             <Button
...
//         >
//           <CardHeader className="flex items-center justify-center space-x-2 p-center">
//             <h1 className="font-bold p-4xl">Generate Notes</h1>
//           </CardHeader>
//           <p className="p-gray-600 p-center mt-2 mb-4">
//             Quickly create organized notes for your meetings or study sessions.
//           </p>
...
//         >
//           <CardHeader className="flex items-center justify-center space-x-2 p-center">
//             <h1 className="font-bold p-4xl">Publish Notes</h1>
//           </CardHeader>
//           <p className="p-gray-600 p-center mt-2 mb-4">
//             Publish your notes to help others.
//           </p>
